...
$progress = mysqli_query($con,"SELECT SQL_CALC_FOUND_ROWS * FROM progress WHERE enable='1' ORDER BY created_date DESC LIMIT $start_row, $rows_per_page ");
...
$picture_ = mysqli_query("SELECT * FROM progress WHERE enable='1' ORDER BY created_date DESC ");
