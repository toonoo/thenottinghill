...
// Form object
var fslidedelete = new ew_Form("fslidedelete");
...
<?php if ($slide->image->Visible) { // image ?>
		<th><span id="elh_slide_image" class="slide_image"><?php echo $slide->image->FldCaption() ?></span></th>
<?php } ?>
<?php if ($slide->enable->Visible) { // enable ?>
		<th><span id="elh_slide_enable" class="slide_enable"><?php echo $slide->enable->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $slide_delete->RowCnt ?>_slide_enable" class="slide_enable">
