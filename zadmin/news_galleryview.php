...
<?php if ($news_gallery->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_news_gallery_id"><?php echo $news_gallery->id->FldCaption() ?></span></td>
		<td<?php echo $news_gallery->id->CellAttributes() ?>>
<span id="el_news_gallery_id">
<span<?php echo $news_gallery->id->ViewAttributes() ?>>
<?php echo $news_gallery->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($news_gallery->image->Visible) { // image ?>
	<tr id="r_image">
		<td><span id="elh_news_gallery_image"><?php echo $news_gallery->image->FldCaption() ?></span></td>
...
<?php echo $news_gallery->image->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($news_gallery->enable->Visible) { // enable ?>
	<tr id="r_enable">
		<td><span id="elh_news_gallery_enable"><?php echo $news_gallery->enable->FldCaption() ?></span></td>
...
<?php echo $news_gallery->enable->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($news_gallery->created_date->Visible) { // created_date ?>
	<tr id="r_created_date">
		<td><span id="elh_news_gallery_created_date"><?php echo $news_gallery->created_date->FldCaption() ?></span></td>
...
<?php echo $news_gallery->created_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($news_gallery->modified_date->Visible) { // modified_date ?>
	<tr id="r_modified_date">
		<td><span id="elh_news_gallery_modified_date"><?php echo $news_gallery->modified_date->FldCaption() ?></span></td>
...
<?php echo $news_gallery->modified_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
