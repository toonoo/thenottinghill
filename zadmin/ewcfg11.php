...
define("EW_PROJECT_NAME", "_20150702_nottinghill", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{1B3DE6F9-6AA9-4A0A-BD16-3CDE31B2DBC1}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'oVp24HbYgNee5m20', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/_20150702_nottinghill.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_HOST", 'zaxis5', TRUE);
define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", 'root', TRUE);
define("EW_CONN_PASS", '', TRUE);
define("EW_CONN_DB", 'nottinghill_db', TRUE);
...
// File upload
define("EW_UPLOAD_DEST_PATH", "../images/upload/", TRUE); // Upload destination path (relative to app root)
