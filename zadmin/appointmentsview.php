...
$appointments_view = NULL; // Initialize page object first

class cappointments_view extends cappointments {
	...
	// Page object name
	var $PageObjName = 'appointments_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "appointmentslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "appointmentslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "appointmentslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($appointments_view)) $appointments_view = new cappointments_view();

// Page init
$appointments_view->Page_Init();

// Page main
$appointments_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$appointments_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var appointments_view = new ew_Page("appointments_view");
appointments_view.PageID = "view"; // Page ID
var EW_PAGE_ID = appointments_view.PageID; // For backward compatibility

// Form object
var fappointmentsview = new ew_Form("fappointmentsview");

// Form_CustomValidate event
fappointmentsview.Form_CustomValidate = 
...
fappointmentsview.ValidateRequired = true;
<?php } else { ?>
fappointmentsview.ValidateRequired = false; 
<?php } ?>
...
<?php $appointments_view->ExportOptions->Render("body") ?>
<?php
	foreach ($appointments_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $appointments_view->ShowPageHeader(); ?>
<?php
$appointments_view->ShowMessage();
?>
<form name="fappointmentsview" id="fappointmentsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($appointments_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $appointments_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="appointments">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($appointments->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_appointments_id"><?php echo $appointments->id->FldCaption() ?></span></td>
		<td<?php echo $appointments->id->CellAttributes() ?>>
<span id="el_appointments_id">
<span<?php echo $appointments->id->ViewAttributes() ?>>
<?php echo $appointments->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($appointments->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_appointments_name"><?php echo $appointments->name->FldCaption() ?></span></td>
		<td<?php echo $appointments->name->CellAttributes() ?>>
<span id="el_appointments_name">
<span<?php echo $appointments->name->ViewAttributes() ?>>
<?php echo $appointments->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($appointments->lastname->Visible) { // lastname ?>
	<tr id="r_lastname">
		<td><span id="elh_appointments_lastname"><?php echo $appointments->lastname->FldCaption() ?></span></td>
...
<?php echo $appointments->lastname->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($appointments->_email->Visible) { // email ?>
	<tr id="r__email">
		<td><span id="elh_appointments__email"><?php echo $appointments->_email->FldCaption() ?></span></td>
...
<?php echo $appointments->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($appointments->phone->Visible) { // phone ?>
	<tr id="r_phone">
		<td><span id="elh_appointments_phone"><?php echo $appointments->phone->FldCaption() ?></span></td>
...
<?php echo $appointments->phone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($appointments->date->Visible) { // date ?>
	<tr id="r_date">
		<td><span id="elh_appointments_date"><?php echo $appointments->date->FldCaption() ?></span></td>
		<td<?php echo $appointments->date->CellAttributes() ?>>
<span id="el_appointments_date">
<span<?php echo $appointments->date->ViewAttributes() ?>>
<?php echo $appointments->date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($appointments->time->Visible) { // time ?>
	<tr id="r_time">
		<td><span id="elh_appointments_time"><?php echo $appointments->time->FldCaption() ?></span></td>
		<td<?php echo $appointments->time->CellAttributes() ?>>
<span id="el_appointments_time">
<span<?php echo $appointments->time->ViewAttributes() ?>>
<?php echo $appointments->time->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($appointments->detail->Visible) { // detail ?>
	<tr id="r_detail">
		<td><span id="elh_appointments_detail"><?php echo $appointments->detail->FldCaption() ?></span></td>
		<td<?php echo $appointments->detail->CellAttributes() ?>>
<span id="el_appointments_detail">
<span<?php echo $appointments->detail->ViewAttributes() ?>>
<?php echo $appointments->detail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($appointments->enable->Visible) { // enable ?>
	<tr id="r_enable">
		<td><span id="elh_appointments_enable"><?php echo $appointments->enable->FldCaption() ?></span></td>
...
<?php echo $appointments->enable->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($appointments->created_date->Visible) { // created_date ?>
	<tr id="r_created_date">
		<td><span id="elh_appointments_created_date"><?php echo $appointments->created_date->FldCaption() ?></span></td>
...
<?php echo $appointments->created_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($appointments->modified_date->Visible) { // modified_date ?>
	<tr id="r_modified_date">
		<td><span id="elh_appointments_modified_date"><?php echo $appointments->modified_date->FldCaption() ?></span></td>
...
<?php echo $appointments->modified_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fappointmentsview.Init();
</script>
<?php
$appointments_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$appointments_view->Page_Terminate();
?>
