...
$gallery_delete = NULL; // Initialize page object first

class cgallery_delete extends cgallery {
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			if ($this->image->UseColorbox) {
				...
				$this->image->LinkAttrs["data-rel"] = "gallery_x_image";
...
// Create page object
if (!isset($gallery_delete)) $gallery_delete = new cgallery_delete();
...
// Form object
var fgallerydelete = new ew_Form("fgallerydelete");

// Form_CustomValidate event
fgallerydelete.Form_CustomValidate = 
...
fgallerydelete.ValidateRequired = true;
<?php } else { ?>
fgallerydelete.ValidateRequired = false; 
<?php } ?>
...
if ($gallery_delete->Recordset = $gallery_delete->LoadRecordset())
	$gallery_deleteTotalRecs = $gallery_delete->Recordset->RecordCount(); // Get record count
if ($gallery_deleteTotalRecs <= 0) { // No record found, exit
	if ($gallery_delete->Recordset)
...
?>
<form name="fgallerydelete" id="fgallerydelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($gallery_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $gallery_delete->Token ?>">
<?php } ?>
...
<?php if ($gallery->image->Visible) { // image ?>
		<th><span id="elh_gallery_image" class="gallery_image"><?php echo $gallery->image->FldCaption() ?></span></th>
<?php } ?>
<?php if ($gallery->description_th->Visible) { // description_th ?>
		<th><span id="elh_gallery_description_th" class="gallery_description_th"><?php echo $gallery->description_th->FldCaption() ?></span></th>
<?php } ?>
<?php if ($gallery->description_en->Visible) { // description_en ?>
		<th><span id="elh_gallery_description_en" class="gallery_description_en"><?php echo $gallery->description_en->FldCaption() ?></span></th>
<?php } ?>
<?php if ($gallery->enable->Visible) { // enable ?>
		<th><span id="elh_gallery_enable" class="gallery_enable"><?php echo $gallery->enable->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $gallery_delete->RowCnt ?>_gallery_description_th" class="gallery_description_th">
...
<span id="el<?php echo $gallery_delete->RowCnt ?>_gallery_description_en" class="gallery_description_en">
...
<span id="el<?php echo $gallery_delete->RowCnt ?>_gallery_enable" class="gallery_enable">
