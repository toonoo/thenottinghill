...
// Page object
var plans_view = new ew_Page("plans_view");
plans_view.PageID = "view"; // Page ID
var EW_PAGE_ID = plans_view.PageID; // For backward compatibility

// Form object
var fplansview = new ew_Form("fplansview");
...
<?php if ($plans->name_th->Visible) { // name_th ?>
	<tr id="r_name_th">
		<td><span id="elh_plans_name_th"><?php echo $plans->name_th->FldCaption() ?></span></td>
		<td<?php echo $plans->name_th->CellAttributes() ?>>
<span id="el_plans_name_th">
<span<?php echo $plans->name_th->ViewAttributes() ?>>
<?php echo $plans->name_th->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($plans->name_en->Visible) { // name_en ?>
	<tr id="r_name_en">
		<td><span id="elh_plans_name_en"><?php echo $plans->name_en->FldCaption() ?></span></td>
		<td<?php echo $plans->name_en->CellAttributes() ?>>
<span id="el_plans_name_en">
<span<?php echo $plans->name_en->ViewAttributes() ?>>
<?php echo $plans->name_en->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($plans->detail_th->Visible) { // detail_th ?>
	<tr id="r_detail_th">
		<td><span id="elh_plans_detail_th"><?php echo $plans->detail_th->FldCaption() ?></span></td>
		<td<?php echo $plans->detail_th->CellAttributes() ?>>
<span id="el_plans_detail_th">
<span<?php echo $plans->detail_th->ViewAttributes() ?>>
<?php echo $plans->detail_th->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($plans->detail_en->Visible) { // detail_en ?>
	<tr id="r_detail_en">
		<td><span id="elh_plans_detail_en"><?php echo $plans->detail_en->FldCaption() ?></span></td>
		<td<?php echo $plans->detail_en->CellAttributes() ?>>
<span id="el_plans_detail_en">
<span<?php echo $plans->detail_en->ViewAttributes() ?>>
<?php echo $plans->detail_en->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($plans->image->Visible) { // image ?>
	<tr id="r_image">
		<td><span id="elh_plans_image"><?php echo $plans->image->FldCaption() ?></span></td>
		<td<?php echo $plans->image->CellAttributes() ?>>
<span id="el_plans_image">
<span>
<?php echo ew_GetFileViewTag($plans->image, $plans->image->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($plans->enable->Visible) { // enable ?>
	<tr id="r_enable">
		<td><span id="elh_plans_enable"><?php echo $plans->enable->FldCaption() ?></span></td>
...
<input type="checkbox" value="<?php echo $plans->enable->ViewValue ?>" checked="checked" disabled="disabled">
<?php } else { ?>
<input type="checkbox" value="<?php echo $plans->enable->ViewValue ?>" disabled="disabled">
<?php } ?>
</span>
</span>
</td>
...
<?php } ?>
<?php if ($plans->created_date->Visible) { // created_date ?>
	<tr id="r_created_date">
		<td><span id="elh_plans_created_date"><?php echo $plans->created_date->FldCaption() ?></span></td>
		<td<?php echo $plans->created_date->CellAttributes() ?>>
<span id="el_plans_created_date">
<span<?php echo $plans->created_date->ViewAttributes() ?>>
<?php echo $plans->created_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($plans->modified_date->Visible) { // modified_date ?>
	<tr id="r_modified_date">
		<td><span id="elh_plans_modified_date"><?php echo $plans->modified_date->FldCaption() ?></span></td>
		<td<?php echo $plans->modified_date->CellAttributes() ?>>
<span id="el_plans_modified_date">
<span<?php echo $plans->modified_date->ViewAttributes() ?>>
<?php echo $plans->modified_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
