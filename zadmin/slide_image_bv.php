...
$slide_image_blobview = NULL; // Initialize page object first

class cslide_image_blobview extends cslide {
	...
	// Page object name
	var $PageObjName = 'slide_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('slide', 'x_image');
...
// Create page object
if (!isset($slide_image_blobview)) $slide_image_blobview = new cslide_image_blobview();

// Page init
$slide_image_blobview->Page_Init();

// Page main
$slide_image_blobview->Page_Main();
?>
<?php
$slide_image_blobview->Page_Terminate();
?>
