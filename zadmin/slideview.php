	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			if ($this->image->UseColorbox) {
				...
				$this->image->LinkAttrs["data-rel"] = "slide_x_image";
...
// Form object
var fslideview = new ew_Form("fslideview");
...
<?php if ($slide->image->Visible) { // image ?>
	<tr id="r_image">
		<td><span id="elh_slide_image"><?php echo $slide->image->FldCaption() ?></span></td>
		<td<?php echo $slide->image->CellAttributes() ?>>
<span id="el_slide_image">
<span>
<?php echo ew_GetFileViewTag($slide->image, $slide->image->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($slide->enable->Visible) { // enable ?>
	<tr id="r_enable">
		<td><span id="elh_slide_enable"><?php echo $slide->enable->FldCaption() ?></span></td>
		<td<?php echo $slide->enable->CellAttributes() ?>>
<span id="el_slide_enable">
<span<?php echo $slide->enable->ViewAttributes() ?>>
<?php if (ew_ConvertToBool($slide->enable->CurrentValue)) { ?>
<input type="checkbox" value="<?php echo $slide->enable->ViewValue ?>" checked="checked" disabled="disabled">
<?php } else { ?>
<input type="checkbox" value="<?php echo $slide->enable->ViewValue ?>" disabled="disabled">
<?php } ?>
</span>
</span>
</td>
...
<?php } ?>
<?php if ($slide->created_date->Visible) { // created_date ?>
	<tr id="r_created_date">
		<td><span id="elh_slide_created_date"><?php echo $slide->created_date->FldCaption() ?></span></td>
		<td<?php echo $slide->created_date->CellAttributes() ?>>
<span id="el_slide_created_date">
<span<?php echo $slide->created_date->ViewAttributes() ?>>
<?php echo $slide->created_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($slide->modified_date->Visible) { // modified_date ?>
	<tr id="r_modified_date">
		<td><span id="elh_slide_modified_date"><?php echo $slide->modified_date->FldCaption() ?></span></td>
		<td<?php echo $slide->modified_date->CellAttributes() ?>>
<span id="el_slide_modified_date">
<span<?php echo $slide->modified_date->ViewAttributes() ?>>
<?php echo $slide->modified_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
