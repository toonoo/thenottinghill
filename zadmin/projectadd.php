...
$project_add = NULL; // Initialize page object first

class cproject_add extends cproject {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "projectview.php")
	...
	function LoadDefaultValues() {
		...
		$this->sequence->CurrentValue = NULL;
		$this->sequence->OldValue = $this->sequence->CurrentValue;
		$this->detail->CurrentValue = NULL;
		$this->detail->OldValue = $this->detail->CurrentValue;
		$this->staus->CurrentValue = NULL;
		$this->staus->OldValue = $this->staus->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// staus
		$this->staus->SetDbValueDef($rsnew, $this->staus->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($project_add)) $project_add = new cproject_add();

// Page init
$project_add->Page_Init();

// Page main
$project_add->Page_Main();
...
// Page object
var project_add = new ew_Page("project_add");
project_add.PageID = "add"; // Page ID
var EW_PAGE_ID = project_add.PageID; // For backward compatibility

// Form object
var fprojectadd = new ew_Form("fprojectadd");
...
fprojectadd.Form_CustomValidate = 
...
fprojectadd.ValidateRequired = true;
<?php } else { ?>
fprojectadd.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="fprojectadd" id="fprojectadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($project_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $project_add->Token ?>">
<?php } ?>
