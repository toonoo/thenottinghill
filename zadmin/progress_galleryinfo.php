...
$progress_gallery = NULL;

//
// Table class for progress_gallery
//
class cprogress_gallery extends cTable {
	var $id;
	var $image;
	var $enable;
	var $created_date;
	...
	function __construct() {
		...
		$this->TableVar = 'progress_gallery';
		$this->TableName = 'progress_gallery';
		...
		// id
		$this->id = new cField('progress_gallery', 'progress_gallery', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// image
		$this->image = new cField('progress_gallery', 'progress_gallery', 'x_image', 'image', '`image`', '`image`', 200, -1, FALSE, '`image`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['image'] = &$this->image;

		// enable
		$this->enable = new cField('progress_gallery', 'progress_gallery', 'x_enable', 'enable', '`enable`', '`enable`', 202, -1, FALSE, '`enable`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->enable->FldDataType = EW_DATATYPE_BOOLEAN;
		$this->fields['enable'] = &$this->enable;

		// created_date
		$this->created_date = new cField('progress_gallery', 'progress_gallery', 'x_created_date', 'created_date', '`created_date`', 'DATE_FORMAT(`created_date`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`created_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// modified_date
		$this->modified_date = new cField('progress_gallery', 'progress_gallery', 'x_modified_date', 'modified_date', '`modified_date`', 'DATE_FORMAT(`modified_date`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`modified_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`progress_gallery`";
	}
	...
	// Update Table
	var $UpdateTable = "`progress_gallery`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "progress_gallerylist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("progress_galleryview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("progress_galleryview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "progress_galleryadd.php?" . $this->UrlParm($parm);
		else
			return "progress_galleryadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("progress_galleryedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("progress_galleryadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("progress_gallerydelete.php", $this->UrlParm());
	}
