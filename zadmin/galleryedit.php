...
$gallery_edit = NULL; // Initialize page object first

class cgallery_edit extends cgallery {
...
// Create page object
if (!isset($gallery_edit)) $gallery_edit = new cgallery_edit();
...
// Form object
var fgalleryedit = new ew_Form("fgalleryedit");
...
fgalleryedit.Form_CustomValidate = 
...
fgalleryedit.ValidateRequired = true;
<?php } else { ?>
fgalleryedit.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="fgalleryedit" id="fgalleryedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($gallery_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $gallery_edit->Token ?>">
<?php } ?>
...
<?php if ($gallery->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_gallery_id" class="col-sm-2 control-label ewLabel"><?php echo $gallery->id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $gallery->id->CellAttributes() ?>>
<span id="el_gallery_id">
<span<?php echo $gallery->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $gallery->id->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($gallery->id->CurrentValue) ?>">
