...
$plans_house_image_blobview = NULL; // Initialize page object first

class cplans_house_image_blobview extends cplans_house {
	...
	// Page object name
	var $PageObjName = 'plans_house_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('plans_house', 'x_image');
...
// Create page object
if (!isset($plans_house_image_blobview)) $plans_house_image_blobview = new cplans_house_image_blobview();

// Page init
$plans_house_image_blobview->Page_Init();

// Page main
$plans_house_image_blobview->Page_Main();
?>
<?php
$plans_house_image_blobview->Page_Terminate();
?>
