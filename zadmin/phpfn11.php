...
function ew_AutoLoad($class) {
	...
	if (substr($class, 0, 1) == "c") {
		if ($class == "cnottinghill_db_db") {
			$file = "nottinghill_dbdb.php";
		} else {
		$fn = "%cls%info.php";
...
function CurrentProjectID() {
	...
	return "{1B3DE6F9-6AA9-4A0A-BD16-3CDE31B2DBC1}";
}
