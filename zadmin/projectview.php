...
$project_view = NULL; // Initialize page object first

class cproject_view extends cproject {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "projectlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "projectlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "projectlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($project_view)) $project_view = new cproject_view();

// Page init
$project_view->Page_Init();

// Page main
$project_view->Page_Main();
...
// Page object
var project_view = new ew_Page("project_view");
project_view.PageID = "view"; // Page ID
var EW_PAGE_ID = project_view.PageID; // For backward compatibility

// Form object
var fprojectview = new ew_Form("fprojectview");

// Form_CustomValidate event
fprojectview.Form_CustomValidate = 
...
fprojectview.ValidateRequired = true;
<?php } else { ?>
fprojectview.ValidateRequired = false; 
<?php } ?>
...
<?php
	foreach ($project_view->OtherOptions as &$option)
		$option->Render("body");
?>
...
?>
<form name="fprojectview" id="fprojectview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($project_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $project_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="project">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($project->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_project_id"><?php echo $project->id->FldCaption() ?></span></td>
		<td<?php echo $project->id->CellAttributes() ?>>
<span id="el_project_id">
<span<?php echo $project->id->ViewAttributes() ?>>
<?php echo $project->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($project->image->Visible) { // image ?>
	<tr id="r_image">
		<td><span id="elh_project_image"><?php echo $project->image->FldCaption() ?></span></td>
		<td<?php echo $project->image->CellAttributes() ?>>
<span id="el_project_image">
<span<?php echo $project->image->ViewAttributes() ?>>
<?php echo $project->image->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($project->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_project_name"><?php echo $project->name->FldCaption() ?></span></td>
		<td<?php echo $project->name->CellAttributes() ?>>
<span id="el_project_name">
<span<?php echo $project->name->ViewAttributes() ?>>
<?php echo $project->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($project->sequence->Visible) { // sequence ?>
	<tr id="r_sequence">
		<td><span id="elh_project_sequence"><?php echo $project->sequence->FldCaption() ?></span></td>
		<td<?php echo $project->sequence->CellAttributes() ?>>
<span id="el_project_sequence">
<span<?php echo $project->sequence->ViewAttributes() ?>>
<?php echo $project->sequence->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($project->detail->Visible) { // detail ?>
	<tr id="r_detail">
		<td><span id="elh_project_detail"><?php echo $project->detail->FldCaption() ?></span></td>
		<td<?php echo $project->detail->CellAttributes() ?>>
<span id="el_project_detail">
<span<?php echo $project->detail->ViewAttributes() ?>>
<?php echo $project->detail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($project->staus->Visible) { // staus ?>
	<tr id="r_staus">
		<td><span id="elh_project_staus"><?php echo $project->staus->FldCaption() ?></span></td>
		<td<?php echo $project->staus->CellAttributes() ?>>
<span id="el_project_staus">
<span<?php echo $project->staus->ViewAttributes() ?>>
<?php echo $project->staus->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($project->enable->Visible) { // enable ?>
	<tr id="r_enable">
		<td><span id="elh_project_enable"><?php echo $project->enable->FldCaption() ?></span></td>
		<td<?php echo $project->enable->CellAttributes() ?>>
<span id="el_project_enable">
<span<?php echo $project->enable->ViewAttributes() ?>>
<?php echo $project->enable->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($project->created_date->Visible) { // created_date ?>
	<tr id="r_created_date">
		<td><span id="elh_project_created_date"><?php echo $project->created_date->FldCaption() ?></span></td>
...
<?php echo $project->created_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($project->modified_date->Visible) { // modified_date ?>
	<tr id="r_modified_date">
		<td><span id="elh_project_modified_date"><?php echo $project->modified_date->FldCaption() ?></span></td>
...
<?php echo $project->modified_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
