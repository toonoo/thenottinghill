...
$plans_image_blobview = NULL; // Initialize page object first

class cplans_image_blobview extends cplans {
	...
	// Page object name
	var $PageObjName = 'plans_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('plans', 'x_image');
...
// Create page object
if (!isset($plans_image_blobview)) $plans_image_blobview = new cplans_image_blobview();

// Page init
$plans_image_blobview->Page_Init();

// Page main
$plans_image_blobview->Page_Main();
?>
<?php
$plans_image_blobview->Page_Terminate();
?>
