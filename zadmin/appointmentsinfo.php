...
//
class cappointments extends cTable {
	var $id;
	var $name;
	var $lastname;
	var $_email;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('appointments', 'appointments', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// name
		$this->name = new cField('appointments', 'appointments', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name'] = &$this->name;

		// lastname
		$this->lastname = new cField('appointments', 'appointments', 'x_lastname', 'lastname', '`lastname`', '`lastname`', 200, -1, FALSE, '`lastname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['lastname'] = &$this->lastname;

		// email
		$this->_email = new cField('appointments', 'appointments', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['email'] = &$this->_email;

		// phone
		$this->phone = new cField('appointments', 'appointments', 'x_phone', 'phone', '`phone`', '`phone`', 200, -1, FALSE, '`phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['phone'] = &$this->phone;

		// date
		$this->date = new cField('appointments', 'appointments', 'x_date', 'date', '`date`', 'DATE_FORMAT(`date`, \'%Y/%m/%d %H:%i:%s\')', 133, 9, FALSE, '`date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->date->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['date'] = &$this->date;

		// time
		$this->time = new cField('appointments', 'appointments', 'x_time', 'time', '`time`', 'DATE_FORMAT(`time`, \'%Y/%m/%d %H:%i:%s\')', 134, 9, FALSE, '`time`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->time->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['time'] = &$this->time;

		// detail
		$this->detail = new cField('appointments', 'appointments', 'x_detail', 'detail', '`detail`', '`detail`', 201, -1, FALSE, '`detail`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['detail'] = &$this->detail;

		// enable
		$this->enable = new cField('appointments', 'appointments', 'x_enable', 'enable', '`enable`', '`enable`', 202, -1, FALSE, '`enable`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->enable->FldDataType = EW_DATATYPE_BOOLEAN;
		$this->fields['enable'] = &$this->enable;

		// created_date
		$this->created_date = new cField('appointments', 'appointments', 'x_created_date', 'created_date', '`created_date`', 'DATE_FORMAT(`created_date`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`created_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// modified_date
		$this->modified_date = new cField('appointments', 'appointments', 'x_modified_date', 'modified_date', '`modified_date`', 'DATE_FORMAT(`modified_date`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`modified_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`appointments`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("appointmentsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("appointmentsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "appointmentsadd.php?" . $this->UrlParm($parm);
		else
			return "appointmentsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("appointmentsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("appointmentsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("appointmentsdelete.php", $this->UrlParm());
	}
