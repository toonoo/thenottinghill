...
// Form object
var fslideedit = new ew_Form("fslideedit");
...
?>
<form name="fslideedit" id="fslideedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($slide->id->CurrentValue) ?>">
<?php echo $slide->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($slide->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_slide_image" class="col-sm-2 control-label ewLabel"><?php echo $slide->image->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $slide->image->CellAttributes() ?>>
...
<input type="hidden" name="fn_x_image" id= "fn_x_image" value="<?php echo $slide->image->Upload->FileName ?>">
...
<input type="hidden" name="fx_x_image" id= "fx_x_image" value="<?php echo $slide->image->UploadAllowedFileExt ?>">
<input type="hidden" name="fm_x_image" id= "fm_x_image" value="<?php echo $slide->image->UploadMaxFileSize ?>">
</div>
