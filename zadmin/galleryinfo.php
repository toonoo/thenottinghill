...
//
// Table class for gallery
//
class cgallery extends cTable {
	var $id;
	var $image;
	var $description_th;
	var $description_en;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('gallery', 'gallery', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// image
		$this->image = new cField('gallery', 'gallery', 'x_image', 'image', '`image`', '`image`', 200, -1, TRUE, '`image`', FALSE, FALSE, FALSE, 'IMAGE');
		$this->fields['image'] = &$this->image;

		// description_th
		$this->description_th = new cField('gallery', 'gallery', 'x_description_th', 'description_th', '`description_th`', '`description_th`', 200, -1, FALSE, '`description_th`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['description_th'] = &$this->description_th;

		// description_en
		$this->description_en = new cField('gallery', 'gallery', 'x_description_en', 'description_en', '`description_en`', '`description_en`', 200, -1, FALSE, '`description_en`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['description_en'] = &$this->description_en;

		// enable
		$this->enable = new cField('gallery', 'gallery', 'x_enable', 'enable', '`enable`', '`enable`', 202, -1, FALSE, '`enable`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->enable->FldDataType = EW_DATATYPE_BOOLEAN;
		$this->fields['enable'] = &$this->enable;

		// created_date
		$this->created_date = new cField('gallery', 'gallery', 'x_created_date', 'created_date', '`created_date`', 'DATE_FORMAT(`created_date`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`created_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// modified_date
		$this->modified_date = new cField('gallery', 'gallery', 'x_modified_date', 'modified_date', '`modified_date`', 'DATE_FORMAT(`modified_date`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`modified_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`gallery`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("galleryview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("galleryview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "galleryadd.php?" . $this->UrlParm($parm);
		else
			return "galleryadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("galleryedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("galleryadd.php", $this->UrlParm($parm));
	}
