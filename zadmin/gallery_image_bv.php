...
$gallery_image_blobview = NULL; // Initialize page object first

class cgallery_image_blobview extends cgallery {
...
// Create page object
if (!isset($gallery_image_blobview)) $gallery_image_blobview = new cgallery_image_blobview();
