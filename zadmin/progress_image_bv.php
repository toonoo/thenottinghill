...
$progress_image_blobview = NULL; // Initialize page object first

class cprogress_image_blobview extends cprogress {
	...
	// Page object name
	var $PageObjName = 'progress_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('progress', 'x_image');
...
// Create page object
if (!isset($progress_image_blobview)) $progress_image_blobview = new cprogress_image_blobview();

// Page init
$progress_image_blobview->Page_Init();

// Page main
$progress_image_blobview->Page_Main();
?>
<?php
$progress_image_blobview->Page_Terminate();
?>
