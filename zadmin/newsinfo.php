...
class cnews extends cTable {
	...
	function __construct() {
		...
		// name_th
		$this->name_th = new cField('news', 'news', 'x_name_th', 'name_th', '`name_th`', '`name_th`', 200, -1, FALSE, '`name_th`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name_th'] = &$this->name_th;

		// name_en
		$this->name_en = new cField('news', 'news', 'x_name_en', 'name_en', '`name_en`', '`name_en`', 200, -1, FALSE, '`name_en`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name_en'] = &$this->name_en;

		// detail_th
		$this->detail_th = new cField('news', 'news', 'x_detail_th', 'detail_th', '`detail_th`', '`detail_th`', 201, -1, FALSE, '`detail_th`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['detail_th'] = &$this->detail_th;

		// detail_en
		$this->detail_en = new cField('news', 'news', 'x_detail_en', 'detail_en', '`detail_en`', '`detail_en`', 201, -1, FALSE, '`detail_en`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// enable
		$this->enable = new cField('news', 'news', 'x_enable', 'enable', '`enable`', '`enable`', 202, -1, FALSE, '`enable`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->enable->FldDataType = EW_DATATYPE_BOOLEAN;
		$this->fields['enable'] = &$this->enable;

		// created_date
		$this->created_date = new cField('news', 'news', 'x_created_date', 'created_date', '`created_date`', 'DATE_FORMAT(`created_date`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`created_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// modified_date
		$this->modified_date = new cField('news', 'news', 'x_modified_date', 'modified_date', '`modified_date`', 'DATE_FORMAT(`modified_date`, \'%Y/%m/%d %H:%i:%s\')', 135, 9, FALSE, '`modified_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
