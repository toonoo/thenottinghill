...
<?php if ($news_gallery->id->Visible) { // id ?>
		<th><span id="elh_news_gallery_id" class="news_gallery_id"><?php echo $news_gallery->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($news_gallery->image->Visible) { // image ?>
		<th><span id="elh_news_gallery_image" class="news_gallery_image"><?php echo $news_gallery->image->FldCaption() ?></span></th>
<?php } ?>
<?php if ($news_gallery->enable->Visible) { // enable ?>
		<th><span id="elh_news_gallery_enable" class="news_gallery_enable"><?php echo $news_gallery->enable->FldCaption() ?></span></th>
<?php } ?>
<?php if ($news_gallery->created_date->Visible) { // created_date ?>
		<th><span id="elh_news_gallery_created_date" class="news_gallery_created_date"><?php echo $news_gallery->created_date->FldCaption() ?></span></th>
<?php } ?>
<?php if ($news_gallery->modified_date->Visible) { // modified_date ?>
		<th><span id="elh_news_gallery_modified_date" class="news_gallery_modified_date"><?php echo $news_gallery->modified_date->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($news_gallery->id->Visible) { // id ?>
		<td<?php echo $news_gallery->id->CellAttributes() ?>>
<span id="el<?php echo $news_gallery_delete->RowCnt ?>_news_gallery_id" class="news_gallery_id">
<span<?php echo $news_gallery->id->ViewAttributes() ?>>
<?php echo $news_gallery->id->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($news_gallery->image->Visible) { // image ?>
...
<span<?php echo $news_gallery->image->ViewAttributes() ?>>
<?php echo $news_gallery->image->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($news_gallery->enable->Visible) { // enable ?>
		<td<?php echo $news_gallery->enable->CellAttributes() ?>>
<span id="el<?php echo $news_gallery_delete->RowCnt ?>_news_gallery_enable" class="news_gallery_enable">
<span<?php echo $news_gallery->enable->ViewAttributes() ?>>
<?php echo $news_gallery->enable->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($news_gallery->created_date->Visible) { // created_date ?>
		<td<?php echo $news_gallery->created_date->CellAttributes() ?>>
<span id="el<?php echo $news_gallery_delete->RowCnt ?>_news_gallery_created_date" class="news_gallery_created_date">
<span<?php echo $news_gallery->created_date->ViewAttributes() ?>>
<?php echo $news_gallery->created_date->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($news_gallery->modified_date->Visible) { // modified_date ?>
		<td<?php echo $news_gallery->modified_date->CellAttributes() ?>>
<span id="el<?php echo $news_gallery_delete->RowCnt ?>_news_gallery_modified_date" class="news_gallery_modified_date">
<span<?php echo $news_gallery->modified_date->ViewAttributes() ?>>
<?php echo $news_gallery->modified_date->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
