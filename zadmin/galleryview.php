...
$gallery_view = NULL; // Initialize page object first

class cgallery_view extends cgallery {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "gallerylist.php"; // Return to list
			}
...
// Create page object
if (!isset($gallery_view)) $gallery_view = new cgallery_view();
...
// Form object
var fgalleryview = new ew_Form("fgalleryview");

// Form_CustomValidate event
fgalleryview.Form_CustomValidate = 
...
fgalleryview.ValidateRequired = true;
<?php } else { ?>
fgalleryview.ValidateRequired = false; 
<?php } ?>
...
<?php
	foreach ($gallery_view->OtherOptions as &$option)
		$option->Render("body");
?>
...
?>
<form name="fgalleryview" id="fgalleryview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($gallery_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $gallery_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="gallery">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($gallery->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_gallery_id"><?php echo $gallery->id->FldCaption() ?></span></td>
		<td<?php echo $gallery->id->CellAttributes() ?>>
<span id="el_gallery_id">
<span<?php echo $gallery->id->ViewAttributes() ?>>
<?php echo $gallery->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gallery->image->Visible) { // image ?>
	<tr id="r_image">
		<td><span id="elh_gallery_image"><?php echo $gallery->image->FldCaption() ?></span></td>
		<td<?php echo $gallery->image->CellAttributes() ?>>
<span id="el_gallery_image">
<span<?php echo $gallery->image->ViewAttributes() ?>>
<?php echo $gallery->image->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gallery->description_th->Visible) { // description_th ?>
	<tr id="r_description_th">
		<td><span id="elh_gallery_description_th"><?php echo $gallery->description_th->FldCaption() ?></span></td>
		<td<?php echo $gallery->description_th->CellAttributes() ?>>
<span id="el_gallery_description_th">
<span<?php echo $gallery->description_th->ViewAttributes() ?>>
<?php echo $gallery->description_th->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gallery->description_en->Visible) { // description_en ?>
	<tr id="r_description_en">
		<td><span id="elh_gallery_description_en"><?php echo $gallery->description_en->FldCaption() ?></span></td>
		<td<?php echo $gallery->description_en->CellAttributes() ?>>
<span id="el_gallery_description_en">
<span<?php echo $gallery->description_en->ViewAttributes() ?>>
<?php echo $gallery->description_en->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gallery->enable->Visible) { // enable ?>
	<tr id="r_enable">
		<td><span id="elh_gallery_enable"><?php echo $gallery->enable->FldCaption() ?></span></td>
		<td<?php echo $gallery->enable->CellAttributes() ?>>
<span id="el_gallery_enable">
<span<?php echo $gallery->enable->ViewAttributes() ?>>
<?php echo $gallery->enable->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gallery->created_date->Visible) { // created_date ?>
	<tr id="r_created_date">
		<td><span id="elh_gallery_created_date"><?php echo $gallery->created_date->FldCaption() ?></span></td>
		<td<?php echo $gallery->created_date->CellAttributes() ?>>
<span id="el_gallery_created_date">
<span<?php echo $gallery->created_date->ViewAttributes() ?>>
<?php echo $gallery->created_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gallery->modified_date->Visible) { // modified_date ?>
	<tr id="r_modified_date">
		<td><span id="elh_gallery_modified_date"><?php echo $gallery->modified_date->FldCaption() ?></span></td>
		<td<?php echo $gallery->modified_date->CellAttributes() ?>>
<span id="el_gallery_modified_date">
<span<?php echo $gallery->modified_date->ViewAttributes() ?>>
<?php echo $gallery->modified_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
