...
Menu1=new Array("home","index.htm","",0,18,60);

Menu2=new Array("about","","",2,18,60);
  Menu2_1=new Array("company profile","about_profile.htm","",0,20,110);
  Menu2_2=new Array("service","about_service.htm","",0,20,110);

//Menu3=new Array("project","update.htm","",2,18,70);
//  Menu3_1=new Array("The Resort & Residence","project1.htm","",0,20,140);
//  Menu3_2=new Array("Land and House","project2_sale.htm","",0,20,140);

Menu3=new Array("contact","contact.htm","",0,18,70);

Menu4=new Array("portfolio","portfolio.htm","",0,18,80);

Menu5=new Array("how to","howto.htm","",0,18,60);

Menu6=new Array("chiang mai info","","",6,18,95);
  Menu6_1=new Array("Lanna","blog-category_title-Lanna-category_id-1.htm","",0,20,95);
  Menu6_2=new Array("Transportation","blog-category_title-Transportation-category_id-12.htm","",0,20,95);
  Menu6_3=new Array("Festival","blog-category_title-Festival-category_id-13.htm","",0,20,95);
  Menu6_4=new Array("Travel","blog-category_title-Travel-category_id-3.htm","",0,20,95);
  Menu6_5=new Array("Temple","blog-category_title-Temple-category_id-14.htm","",0,20,95);
  Menu6_6=new Array("Law","blog-category_title-Law-category_id-24.htm","",0,20,95);
...
var StartLeft=-370;		// Menu offset y coordinate
